...
## data
geno <- read.csv("data/GATK_CMS.csv", row.names = 1)
...
write.csv(cor_rrBLUP,paste("res_",data,"_",repeatNo,"/rrBLUP/cor_rrBLUP.csv", sep = ""))
rownames(rmse_rrBLUP) <- colnames(Pheno)
write.csv(rmse_rrBLUP,paste("res_",data,"_",repeatNo,"/rrBLUP/rmse_rrBLUP.csv", sep = ""))
