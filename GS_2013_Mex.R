setwd("/Users/tomo/Dropbox/sorghum/GS_2013_Mex")
...
dir.create(paste("result_",repeatNo,sep = ""))
...
cor_rrBLUP <- NULL
Ntrait <- ncol(Pheno)
dir.create(paste("result_",repeatNo,"/rrBLUP",sep = ""))

for(trait in 1:Ntrait){
    pdf(paste("result_",repeatNo,"/rrBLUP/", phenolist[trait], "_2013_rrBLUP.pdf", sep = ""))
...
#plot
cor_GAUSS <- NULL
dir.create(paste("result_",repeatNo,"/GAUSS",sep = ""))

for(trait in 1:Ntrait){
    print(paste(trait, phenolist[trait]))
    pdf(paste("result_",repeatNo,"/GAUSS/", phenolist[trait], "_2013_GAUSS.pdf", sep = ""))
...
#plot
cor_RF <- NULL
dir.create(paste("result_",repeatNo,"/RF",sep = ""))
Ntrait <- ncol(Pheno)
phenolist <- colnames(Pheno)

for(trait in 1:Ntrait){
    print(paste(trait, phenolist[trait]))
    pdf(paste("result_",repeatNo,"/RF/", phenolist[trait], "_2013_randomForest.pdf", sep = ""))
...
dir.create(paste("result_",repeatNo,"/ridge",sep = ""))
Ntrait <- ncol(Pheno)
phenolist <- colnames(Pheno)

for(trait in 1:Ntrait){
    print(paste(trait, phenolist[trait]))
    pdf(paste("result_",repeatNo,"/ridge/", phenolist[trait], "_2013_glmnet.ridge.pdf", sep = ""))
...
dir.create(paste("result_",repeatNo,"/elasticnet",sep = ""))
Ntrait <- ncol(Pheno)
phenolist <- colnames(Pheno)
...
for(trait in 1:Ntrait){
    print(paste(trait, phenolist[trait]))
    pdf(paste("result_",repeatNo,"/elasticnet/", phenolist[trait], "_2013_glmnet.elasticnet.pdf", sep = ""))
...
dir.create(paste("result_",repeatNo,"/lasso",sep = ""))
Ntrait <- ncol(Pheno)
phenolist <- colnames(Pheno)

for(trait in 1:Ntrait){
    print(paste(trait, phenolist[trait]))
    pdf(paste("result_",repeatNo,"/lasso/", phenolist[trait], "_2013_glmnet.lasso.pdf", sep = ""))
...
write.csv(cor.vec, paste("result_",repeatNo,"/comparing_GSmethods_",repeatNo,".csv", sep = ""), quote = F)

require(gplots)
pdf(paste("result_",repeatNo,"/heatmap_GS2013MEX_",repeatNo,".pdf", sep = ""))
heatmap.2(
    as.matrix(cor.vec),
    main = "2013_Mex",
    Rowv = TRUE,
