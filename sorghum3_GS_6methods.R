...
dir.create(paste("GS_",data,"_",type, sep = ""))


#### GS rrBLUP #######################################################
require(rrBLUP)
regression <- "G-BLUP"
dir.create(paste("GS_",data,"_",type,"/",regression, sep = ""))
...
for(traitNum in 1:ncol(pheno)){
  ...
  for(N in 1:10){
    dir.create(paste("GS_",data,"_",type,"/",regression,"/fold",N, sep = ""))
    ...
    #plot
    pdf(paste("GS_",data,"_",type,"/", regression,"/fold",N, "/", N, "_", traitname,".pdf", sep = ""))
  ...
  write.csv(predictedvalues,paste("GS_",data,"_",type,"/",regression,"/predictedvalues/predictedvalues_",traitname,"_",regression,".csv",sep=""))

  dir.create(paste("GS_",data,"_",type,"/",regression,"/cor_and_rmse", sep = ""))
  ...
  write.csv(res_values,paste("GS_",data,"_",type,"/",regression,"/cor_and_rmse/cor_and_rmse_",traitname,"_",regression,".csv",sep=""))
...
write.csv(result, paste("GS_",data,"_",type,"/",regression,"/result_",regression,".csv",sep=""))
write.csv(Prediction, paste("GS_",data,"_",type,"/",regression,"/Prediction_",regression,".csv",sep=""))
