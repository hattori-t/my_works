...
dir.create(paste("res_",data,"_",type,"_",repeatNo,sep = ""))
...
for(trait in 1:Ntrait){
    pdf(paste("res_",data,"_",type,"_",repeatNo,"/", phenolist[trait], "_rrBLUP.pdf", sep = ""))
...
write.csv(Predictedvalues.RR,paste("res_",data,"_",type,"_",repeatNo,"/Predictedvalues_rrBLUP.csv", sep = ""))
rownames(cor_rrBLUP) <- colnames(Pheno)
write.csv(cor_rrBLUP,paste("res_",data,"_",type,"_",repeatNo,"/cor_rrBLUP.csv", sep = ""))
rownames(rmse_rrBLUP) <- colnames(Pheno)
write.csv(rmse_rrBLUP,paste("res_",data,"_",type,"_",repeatNo,"/rmse_rrBLUP.csv", sep = ""))
