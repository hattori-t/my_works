...
## Type:5 Cross-validation with BGLR ##
# parameters
...
geno_hetero <- read.csv("data/amat_GATK_all_hetero.csv", row.names = 1)
pheno <- read.csv(paste("data/",data,"_F1.csv",sep=""), row.names=1)
...
setwd(paste("/Users/tomo/Dropbox/sorghum2/BGLR/type5/", data, "_", type, "/AD/fold", repeatNo, sep="" ))
...
#######################
## Additive only (A) ##
setwd(paste("/Users/tomo/Dropbox/sorghum2/BGLR/type5/", data, "_", type, "/A/fold", repeatNo, sep="" ))
