...
setwd(paste("/Users/tomo/Dropbox/sorghum3/type4/", data, "_", type, "/AD/fold", repeatNo, sep="" ))
...
#######################
## Additive only (A) ##
setwd(paste("/Users/tomo/Dropbox/sorghum3/type4/", data, "_", type, "/A/fold", repeatNo, sep="" ))
